              ...
              {Object.keys(this.state.user_login_display).map(key => {
                return (
                  ...
                  <ListItem key={this.state.user_login_display[key]}>
                    <button style = {{marginLeft:"-21px", padding:"1px", border:"none", backgroundColor:"none", width:"450px", display:"block"}} id={this.state.user_login_display[key]} onClick={this.peer_chat_trigger} name={this.state.user_login_display[key]} key={this.state.user_login_display[key]} > <ListItemText primary={this.state.user_login_display[key]} /></button>
